...
public class CircularProgressBarView extends View implements ValueAnimator.AnimatorUpdateListener, BarAnimationListener {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        float dpTextSize = tArray.getDimension(R.styleable.CircularProgressBarView_textSize, textSize);
        textSize = dp2px(dpTextSize);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (BarComponent bar : barComponentsArray) {
            ...
            if (enableText) {
                ...
                canvas.drawText(String.valueOf(Math.round(this.progress * 100)) + "%",
